...
public class FileInputOutputDemo{
    public static void main(String[] args) throws IOException{
        ...
        try{
            ...
            FileOutputStream fout=new FileOutputStream("/home/g/Downloads/result.txt");
                    // Считывание из файла:
            int s=fin.read();
            ...
            JOptionPane.showMessageDialog(null,"Изменения в файл внесены!"," Программа закончила работу",
